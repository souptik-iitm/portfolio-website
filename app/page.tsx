    ...
    <div className="relative min-h-screen bg-[#050505] text-zinc-300 font-sans selection:bg-zinc-800 flex flex-col">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 sm:px-6 py-4 pointer-events-none">
        ...
        <nav className="pointer-events-auto mx-auto flex items-center gap-1 p-1.5 rounded-full border border-zinc-800/80 bg-zinc-950/80 backdrop-blur-xl">
          <Link href="/" className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-zinc-800 text-white text-xs font-medium transition-colors">
            <Home className="w-3.5 h-3.5" /> <span className="hidden sm:inline">Home</span>
          </Link>
          <Link href="/about" className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full text-zinc-400 hover:text-white hover:bg-zinc-900/50 text-xs font-medium transition-colors">
      ...
      <main className="flex-1 px-4 sm:px-12 max-w-5xl mx-auto pt-28 sm:pt-48 w-full">
        ...
        <section className="flex flex-col-reverse md:flex-row gap-12 md:gap-8 items-start justify-between">
          ...
          <div className="flex-1 space-y-6 sm:space-y-8">
            ...
            {/* VIBRANT MOBILE-RESPONSIVE HEADLINE */}
            <div className="space-y-2">
              <h1 className="text-4xl sm:text-6xl md:text-[4.5rem] font-extrabold tracking-tighter leading-[1.1]">
            ...
            {/* Bio */}
            <p className="text-sm sm:text-base text-zinc-400 max-w-md leading-relaxed font-medium">
          ...
          <div className="relative mt-8 md:mt-0 shrink-0 md:pl-20 mx-auto md:mx-0">
            <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-full p-2 border border-zinc-800 bg-zinc-900/50 shadow-2xl">
              <div className="relative w-full h-full rounded-full overflow-hidden">
                <Image src="/profile.png" alt={personalInfo.name} fill className="object-cover" priority sizes="(max-width: 768px) 192px, 256px" />
              </div>
            </div>

            {/* Tag 1: Animating Indian Flag */}
            <div className="absolute top-4 -left-2 sm:top-8 sm:-left-4 flex items-center gap-2 px-3 py-2 rounded-xl border border-zinc-700 bg-zinc-900/80 backdrop-blur-md shadow-xl z-10">
            ...
            {/* Tag 2: Location */}
            <div className="absolute bottom-12 -left-4 sm:bottom-16 sm:-left-8 flex items-center gap-2 px-3 py-2 rounded-xl border border-zinc-700 bg-zinc-900/80 backdrop-blur-md shadow-xl z-10">
              <MapPin className="w-3.5 h-3.5 text-emerald-400" />
              <span className="text-xs font-semibold text-white">India</span>
            </div>

            {/* Tag 3: Focus */}
            <div className="absolute bottom-0 right-0 sm:bottom-4 sm:right-4 flex items-center gap-2 px-3 py-2 rounded-xl border border-zinc-700 bg-zinc-900/80 backdrop-blur-md shadow-xl z-10">
        ...
        <section className="mt-24 sm:mt-32">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-4 p-4 sm:p-5 rounded-2xl border border-zinc-800/80 bg-zinc-900/20 hover:bg-zinc-900/40 transition-colors">
